...
export function MenuBoard() {
  return (
    <div className="menu-board flex h-full w-full flex-col gap-4 bg-menu-cream p-6 text-menu-text">
      <div className="grid min-h-0 flex-1 grid-cols-[1fr_1.16fr_1fr] gap-4">
